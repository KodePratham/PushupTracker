...
export type ClerkOptions = CreateBackendApiOptions & Partial<Pick<CreateAuthenticateRequestOptions['options'], 'jwtKey' | 'proxyUrl' | 'secretKey' | 'publishableKey'>>;
export declare function Clerk(options: ClerkOptions): {
    ...
    remotePublicInterstitial: ({ frontendApi: runtimeFrontendApi, publishableKey: runtimePublishableKey, proxyUrl: runtimeProxyUrl, isSatellite: runtimeIsSatellite, domain: runtimeDomain, ...rest }: Omit<import("./tokens/interstitial").LoadInterstitialOptions, "proxyUrl" | "isSatellite" | "domain">) => Promise<string>;

...
exports.isHttpOrHttps = exports.handleIsSatelliteBooleanOrFn = exports.injectSSRStateIntoObject = exports.nextJsVersionCanOverrideRequestHeaders = exports.setRequestHeadersOnNextResponse = exports.getCookie = exports.getHeader = exports.getAuthStatusFromRequest = exports.getCustomAttributeFromRequest = exports.setCustomAttributeOnRequest = void 0;
...
const handleIsSatelliteBooleanOrFn = (opts, url) => {
    if (typeof opts.isSatellite === 'function') {
        return opts.isSatellite(url);
    }
    return opts.isSatellite || false;
};
exports.handleIsSatelliteBooleanOrFn = handleIsSatelliteBooleanOrFn;

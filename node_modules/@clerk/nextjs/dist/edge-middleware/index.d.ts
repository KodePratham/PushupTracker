...
export declare const clerkApi: {
    ...
    authenticateRequest: ({ apiKey: runtimeApiKey, secretKey: runtimeSecretKey, frontendApi: runtimeFrontendApi, proxyUrl: runtimeProxyUrl, publishableKey: runtimePublishableKey, jwtKey: runtimeJwtKey, ...rest }: Omit<import("@clerk/backend/dist/types/tokens/request").AuthenticateRequestOptions, "apiUrl" | "apiVersion">) => Promise<import("@clerk/backend/dist/types/tokens/authStatus").RequestState>;
    localInterstitial: typeof import("@clerk/backend/dist/types/tokens/interstitial").loadInterstitialFromLocal;
    remotePublicInterstitial: ({ frontendApi: runtimeFrontendApi, publishableKey: runtimePublishableKey, proxyUrl: runtimeProxyUrl, isSatellite: runtimeIsSatellite, domain: runtimeDomain, ...rest }: Omit<import("@clerk/backend/dist/types/tokens/interstitial").LoadInterstitialOptions, "isSatellite" | "proxyUrl" | "domain">) => Promise<string>;
